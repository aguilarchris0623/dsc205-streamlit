...
fig_demographics = px.bar(
    ...
    color='Age_Bin',
    barmode='group',
    title='Demographic Breakdown in 20-Year Bins by Municipal Tier',
    labels={
        'Town_Tier': 'Municipal Population Tier',
        'Percentage': 'Percentage of Tier Population (%)',
        'Age_Bin': 'Age Cohort',
    },
    text_auto='.1f',
