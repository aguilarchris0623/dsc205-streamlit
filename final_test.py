...
latest_df['Deaths per 100k'] = (latest_df.['Total deaths'] / latest_df.['Population']) * 100000
latest_df['Positivity Rate (%)'] = (latest_df.['Number_of_positives'] / latest_df.['Number_of_tests']) * 100
