...
latest_df['Deaths per 100k'] = latest_df.dropna().Total_deaths / latest_df.dropna().Population) * 100000
latest_df['Positivity Rate (%)'] = latest_df.dropna().Number_of_positives / latest_df.dropna().Number_of_tests) * 100
